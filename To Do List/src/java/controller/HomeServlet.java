...
////            todoList = provider.retrieveAllLists();
...
//            System.out.println(todoList.get(1).getContent());
            HttpSession session = request.getSession();

            if (session != null) {
                userList = provider.getUser((String) session.getAttribute("name"));
                provider.todoInsert(userList.get(0).getId(), title, content);
